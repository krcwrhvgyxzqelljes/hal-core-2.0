        ...
        )
{
    ...
    std::cout<<"G0 X:"<<x<<" Y:"<<y<<" Z:"<<z<<" A:"<<a<<" B:"<<b<<" C:"<<c<<std::endl;
}
        ...
        )
{
    ...
    std::cout<<"G"<<g_nr<<" X:"<<first_end<<" Y:"<<second_end<<" Z:"<<axis_end_point<<" Cx"<<first_axis<<" Cy:"<<second_axis<<" A:"<<a<<" B:"<<b<<" C:"<<c<<std::endl;
}
        ...
        )
{
    ...
    std::cout<<"G1 X:"<<x<<" Y:"<<y<<" Z:"<<z<<" A:"<<a<<" B:"<<b<<" c:"<<c<<std::endl;
}
