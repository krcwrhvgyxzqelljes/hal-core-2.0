#ifndef ACISGEOM_HELIXDATA_H
#define ACISGEOM_HELIXDATA_H
#include <gp_Ax3.hxx>
...
public:
  ...
  bool MakeHelix(const ACISGeom_HelixData& theSource, Handle(Geom_BSplineCurve)& theTarget);
