...
""));
        ...
        pushButton_jog_reverse = new QPushButton(groupBox);
        pushButton_jog_reverse->setObjectName(QString::fromUtf8("pushButton_jog_reverse"));

        gridLayout_5->addWidget(pushButton_jog_reverse, 0, 0, 1, 1);

        pushButton_jog_forward = new QPushButton(groupBox);
        pushButton_jog_forward->setObjectName(QString::fromUtf8("pushButton_jog_forward"));

        gridLayout_5->addWidget(pushButton_jog_forward, 1, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_jog_reverse->setText(QCoreApplication::translate("MainWindow", "reverse", nullptr));
        pushButton_jog_forward->setText(QCoreApplication::translate("MainWindow", "forward", nullptr));
