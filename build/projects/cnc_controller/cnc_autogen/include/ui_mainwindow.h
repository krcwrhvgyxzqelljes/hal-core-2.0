...
"color: rgb(0, 0, 0);"));
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/vendor/icons/mail-mark-notjunk.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_machine_on->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/vendor/icons/zoom_min.svg"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_zoom_min->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/vendor/icons/view-bottom.svg"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_view_bottom->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/vendor/icons/refresh.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_reload->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/vendor/icons/open.svg"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_file_open->setIcon(icon7);
        ...
        gridLayout_16->addItem(horizontalSpacer, 0, 19, 1, 1);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/vendor/icons/emergency-stop"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_emergency->setIcon(icon9);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/vendor/icons/view-back.svg"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_view_back->setIcon(icon11);
        ...
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/vendor/icons/view-left.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/vendor/icons/view-top.svg"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_view_top->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/vendor/icons/media-playback-pause.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_pause->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/vendor/icons/zoom_extend.svg"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_fit_all->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/vendor/icons/media-playback-stop.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_stop->setIcon(icon18);
        ...
        menubar->setGeometry(QRect(0, 0, 1103, 19));
